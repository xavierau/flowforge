...
export const invoiceTemplate: Template = {
  id: 'invoice',
  name: 'Invoice Schema',
  description: 'Standard invoice extraction schema with vendor, customer, line items, and totals',
  category: 'Financial',
  icon: 'FileText',
  schema: {
    "$schema": "http://json-schema.org/draft-07/schema#",
    "title": "Invoice Extraction Schema",
    "description": "Schema for extracting structured data from invoices",
    "type": "object",
    "properties": {
      "invoice_number": {
        "type": "string",
